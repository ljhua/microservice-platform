package com.microservice.platform.boot.util;

import cn.hutool.json.JSONUtil;
import com.microservice.platform.base.constant.AuthConstant;
...
public class GitEggAuthUtils {
    ...
    public static GitEggUser getCurrentUser() {
        ...
        try {
            ...
            GitEggUser projectUser = JSONUtil.toBean(userStr, GitEggUser.class);
            return projectUser;
    ...
    public static String getTenantId() {
        ...
        try {
            ...
            if (StringUtils.isEmpty(tenantId) && !StringUtils.isEmpty(user)) {
                ...
                GitEggUser projectUser = JSONUtil.toBean(userStr, GitEggUser.class);
                if (null != projectUser) {
                    tenantId = projectUser.getTenantId();
                }
            }
            return tenantId;
        } catch (UnsupportedEncodingException e) {
