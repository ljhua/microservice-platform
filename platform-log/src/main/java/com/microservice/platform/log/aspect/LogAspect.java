package com.microservice.platform.log.aspect;

import com.microservice.platform.base.annotation.log.AfterLog;
import com.microservice.platform.base.annotation.log.AroundLog;
import com.microservice.platform.base.annotation.log.BeforeLog;
import com.microservice.platform.base.constant.LogLevelConstant;
import com.microservice.platform.base.domain.GitEggLog;
import com.microservice.platform.base.util.JsonUtils;
...
public class LogAspect {
     ...
     * Before切点
     */
    @Pointcut("@annotation(com.microservice.platform.base.annotation.log.BeforeLog)")
     ...
     * After切点
     */
    @Pointcut("@annotation(com.microservice.platform.base.annotation.log.AfterLog)")
     ...
     * Around切点
     */
    @Pointcut("@annotation(com.microservice.platform.base.annotation.log.AroundLog)")
